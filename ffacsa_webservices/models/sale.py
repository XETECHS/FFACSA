...
class SaleOrder(models.Model):
    ...
    def send_ffacsa_quotation(self):
        ...
        parent = self.partner_id.parent_id if self.partner_id.parent_id else self.partner_id.parent_id
        if partner.street:
